...
#             reviws = JobData.css('#averageCustomerReviews_feature_div')
#             dreviws=reviws.css('span#acrCustomerReviewText::text').extract()
#             # print(dreviws[0])
...
#             reviews_feature_div = response.css('#customer-reviews_feature_div')
#             dreviews_feature_div=reviews_feature_div.css('span::text').extract()
#             print(dreviews_feature_div[5])
...
#                 'price':price[0],
#                 'review':{'total':dreviws[0],'rateing':dreviews_feature_div[5]},
